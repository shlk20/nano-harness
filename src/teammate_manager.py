...
from constants import TEAM_DIR, WORKDIR, TASKS_DIR, IDLE_TIMEOUT, POLL_INTERVAL
from task_manager import TaskManager
from message_bus import MessageBus
from tools import run_bash, run_edit, run_read, run_write

class TeammateManager:
    def __init__(self, client, model: str, bus: MessageBus, task_mgr: TaskManager):
    ...
    def _save(self):
        self.config_path.write_text(json.dumps(
            self.config, indent=2), encoding="utf-8")
    ...
    def spawn(self, name: str, role: str, prompt: str) -> str:
        ...
        threading.Thread(target=self._loop, args=(
            name, role, prompt), daemon=True).start()
    ...
    def _loop(self, name: str, role: str, prompt: str):
        ...
        tools = [
            ...
            {"name": "edit_file", "description": "Edit file.", "input_schema": {"type": "object", "properties": {"path": {
                "type": "string"}, "old_text": {"type": "string"}, "new_text": {"type": "string"}}, "required": ["path", "old_text", "new_text"]}},
            {"name": "send_message", "description": "Send message.", "input_schema": {"type": "object", "properties": {
                "to": {"type": "string"}, "content": {"type": "string"}}, "required": ["to", "content"]}},
